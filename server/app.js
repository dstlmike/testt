...
// view engine setup
app.set('views', path.join(__dirname + '/server/views')); //, 'server/views', 'client/views');
...
app.use(express.static(path.join(__dirname + '/server/public'))); //, '/client/public', '/server/public')); // __dirname + 'client/public'})));
